...
function loadHabilidades(){
    if(habilidades.includes('load')){

    }else if(habilidades.includes('shoot')){
        document.getElementById('shootP').textContent='0';
    }else if(habilidades.includes('explosion')){
        document.getElementById('explosionP').textContent='2/5';
    }
}